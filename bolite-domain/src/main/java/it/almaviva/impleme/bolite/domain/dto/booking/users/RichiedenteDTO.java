...
public class RichiedenteDTO {
    ...
    @ApiModelProperty(example = "PNCNDR80C25A390K", notes = "Il campo deve essere senza prefisso TINIT-")
    private String codiFisc;

    @ApiModelProperty(example = "PNCNDR80C25A390K", notes = "Il campo deve essere senza prefisso TINIT-")
    private String piva;

    @ApiModelProperty(example = "s.panacore@gmail.com")
    ...
    @JsonProperty(required = true)
    @NotNull(message = "Valorizzare il campo flagOrganizzatore")
    @ApiModelProperty(required = true, example = "false", allowableValues = "true, false")
    private Boolean flagOrganizzatore;
